...
class BookRecommendAdapter(private val mBook: List<BookModel>, private val context: Context): RecyclerView.Adapter<BookRecommendAdapter.ViewHolder>() {
    private val contextHere = context
    private val options: RequestOptions =
        RequestOptions().centerCrop().placeholder(R.drawable.ic_baseline_load)
            .error(R.drawable.ic_baseline_close)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.book_recycler, parent, false)
